(() => {
  ...
  class u {
    advance(t) {
      ...
      if (this.lerp)
        ...
        this.currentTime += t;
        const i = d(0, this.currentTime / this.duration, 1);
        e = i >= 1;
  ...
  class w {
    ...
    onWheel = (t) => {
      ...
      (e *= 1 === s ? g : 2 === s ? this.windowWidth : 1),
        (i *= 1 === s ? g : 2 === s ? this.windowHeight : 1),
  ...
  class v {
    constructor({
      ...
      (this.__isSmooth = !1),
        ...
        (this.animate = new u()),
        (this.emitter = new p()),
        (this.dimensions = new m({ wrapper: t, content: e, autoResize: L })),
